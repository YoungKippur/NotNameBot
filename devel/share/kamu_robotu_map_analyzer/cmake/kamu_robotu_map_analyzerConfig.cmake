...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kamu_robotu_map_analyzer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kippur/catkin_ws/src/oko_slam/ros_ws/src/kamu_robotu/kamu_robotu_map_analyzer/${idir}'.  ${_report}")
    endif()
