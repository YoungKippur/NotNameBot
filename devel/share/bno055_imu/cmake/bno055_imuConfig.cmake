...
if("TRUE" STREQUAL "TRUE")
  set(bno055_imu_SOURCE_PREFIX /home/kippur/catkin_ws/src/oko_slam/ros_ws/src/bno055_imu)
  set(bno055_imu_DEVEL_PREFIX /home/kippur/catkin_ws/devel)
  ...
  set(bno055_imu_INSTALL_PREFIX /home/kippur/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "https://github.com/matpalm/ros-mpu6050-node " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Mustafa KILINC <mustafa.kilinc@ieee.metu.edu.tr>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bno055_imu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kippur/catkin_ws/src/oko_slam/ros_ws/src/bno055_imu/${idir}'.  ${_report}")
    endif()
    _list_append_unique(bno055_imu_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "bno055_imu")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT bno055_imu_NUM_DUMMY_TARGETS)
      set(bno055_imu_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::bno055_imu::wrapped-linker-option${bno055_imu_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR bno055_imu_NUM_DUMMY_TARGETS "${bno055_imu_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::bno055_imu::wrapped-linker-option${bno055_imu_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND bno055_imu_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(bno055_imu_EXPORTED_TARGETS ${${bno055_imu_dep}_EXPORTED_TARGETS})
endforeach()
